...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('frontpage_about', 'about_story', self.gf('django.db.models.fields.CharField')(max_length=1000, default=''))

    def backwards(self, orm):

        # Changing field 'About.about_story'
        db.alter_column('frontpage_about', 'about_story', self.gf('django.db.models.fields.CharField')(null=True, max_length=1000))

    models = {
        'frontpage.about': {
            'Meta': {'object_name': 'About'},
            'about_image': ('filebrowser.fields.FileBrowseField', [], {'null': 'True', 'max_length': '200', 'blank': 'True'}),
        ...
        'frontpage.brand': {
            ...
            'brand_image': ('filebrowser.fields.FileBrowseField', [], {'null': 'True', 'max_length': '200', 'blank': 'True'}),
            'brand_title': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'frontpage.feature': {
            'Meta': {'object_name': 'Feature'},
            'feature_image': ('filebrowser.fields.FileBrowseField', [], {'null': 'True', 'max_length': '200', 'blank': 'True'}),
        ...
        'frontpage.marketing': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marketing_image': ('filebrowser.fields.FileBrowseField', [], {'null': 'True', 'max_length': '200', 'blank': 'True'}),
        ...
        'frontpage.relationship': {
            ...
            'relationship_image': ('filebrowser.fields.FileBrowseField', [], {'null': 'True', 'max_length': '200', 'blank': 'True'}),
            'relationship_title': ('django.db.models.fields.CharField', [], {'max_length': '40'})
        },
        'frontpage.slider': {
            'Meta': {'object_name': 'Slider'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slider_image': ('filebrowser.fields.FileBrowseField', [], {'null': 'True', 'max_length': '200', 'blank': 'True'}),
