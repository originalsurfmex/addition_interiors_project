...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Skills.skills'
        db.alter_column('frontpage_skills', 'skills', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Skills.skills'
        db.alter_column('frontpage_skills', 'skills', self.gf('django.db.models.fields.TextField')(max_length=300))
    ...
    models = {
        ...
        'frontpage.relationship': {
            ...
            'relationship_image': ('filebrowser.fields.FileBrowseField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
