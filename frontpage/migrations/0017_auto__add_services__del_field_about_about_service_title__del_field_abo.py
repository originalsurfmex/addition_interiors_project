...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('frontpage_services', (
            ...
            ('service', self.gf('django.db.models.fields.CharField')(max_length=400)),
        ))
    ...
    models = {
        ...
        'frontpage.services': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'service': ('django.db.models.fields.CharField', [], {'max_length': '400'}),
        ...
        'frontpage.skills': {
            ...
            'skills_order': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'default': '1', 'blank': 'True'})
        },
        'frontpage.slider': {
